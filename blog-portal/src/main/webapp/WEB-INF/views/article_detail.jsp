		...
		<div class="container">
			<div class="row">
				...
				<div class="span8 page-content">
					...
					<p>Many of us work in an endless stream of tasks, browser
						tasks, social media, emails, meetings, rushing from one thing to
						another, never pausing and never ending.&nbsp;Then the day is
						over, and we are exhausted, and we often have very little to show
						for it. And we start the next day, ready for a mindless stream of
						tasks and distractions.</p>

					<p>I am a fan of going against the stream of what most people
						do, and taking a step back. Is it really worth it? Is this the
						best way? Are we losing our lives to busy-ness and distraction?</p>

					<p>
						What if we did less instead?&nbsp;Of course, I’ve been suggesting
						doing less for six years here on Zen Habits, but it’s a topic
						worth revisiting, because&nbsp;<em>it is so necessary</em>. Today
						I offer a short guide to doing less, for those willing to give it
						a try.
					</p>
					...
					<p>
						I could probably write&nbsp;<a title="The Power of Less"
							...
							entire book</a>&nbsp;on the benefits of doing less, but here’s the
						short version:
					</p>

					<ul>
						<li><strong>You accomplish more</strong>. No, you don’t get
							more done (you’re doing less, after all), but if you do less and
							focus on the important stuff, you actually achieve better
							results, more meaningful accomplishments. This is how I’m able to
							work less but still write hundreds of posts a year (on various
							sites), create ebooks and courses, and more.</li>
						<li><strong>You have less anxiety</strong>. When you let go
							of the distractions and the non-essential, you free yourself from
							the fear that you need to do these things. You learn that your
							world doesn’t fall apart when you let these things go.</li>
						<li><strong>You enjoy life more</strong>. Taking time to
							really focus on an important task, or enjoy the little things,
							rather than rushing through them, is much more enjoyable.</li>
						<li><strong>You create time</strong>. When you do less, all
							of a sudden you have free time! What can you do with all that
							time? How about spend some time with loved ones, read, write,
							make music, exercise, cook healthy meals, start your own
							business, meditate, do yoga?</li>
					</ul>

					<p>I’ll stop with those benefits — they’re sufficient for
						getting started. But I think you’ll discover others as you give
						this a try.</p>
					...
					<p>When you do a task — let’s say writing something — create
						space around that task. Really pay attention, really pour yourself
						into it, and enjoy it. Any task can be enjoyable with the savor
						mindset — yes, even cleaning and doing taxes.</p>

					<p>When you do the task, don’t rush through it, but be mindful,
						be present, and smile.&nbsp;When you’re done with the task, savor
					...
					<p>
						<img class="alignright size-full wp-image-115" alt="Man"
							src="images/temp/man.png" width="250" height="250">If you
						normally do 20-30 things a day (as an example), small and large
						tasks and meetings, that’s great — but are these things important?
						Are they good enough to make the cut of what should be in your
						life?
					</p>

					<p>Instead, think of yourself as a collector. Each day is
						limited, our lives are limited, and we can try to cram as many
						things as we possibly can into these containers, or we can collect
						just the experiences worthy of being in these limited days.</p>

					<p>What would you include in your day if you were culling
						experiences and tasks down to the best ones? My day, as an
						example, often contains these things I love: meditation, writing,
						coffee and reading, spending time with my wife and kids, exercise,
						eating healthy meals, helping people, going for a walk, more
						reading, drinking a glass or two of red wine. Not every day has
						those things, and not in that order, but those are some of the
						things I find worthy of my day.</p>

					<h3>Creating a Day of Less</h3>

					<p>Can you do less today? How would you do it?</p>

					<p>The answer is yes, you can do less today, even if you’ve
						already started with a rush of small tasks. Here’s what I suggest:</p>

					<ol>
						<li><strong>Take a breath</strong>. Take a moment to pause in
							your busy day, and breathe. Pay attention to your breath for a
							minute, then pay attention to your body, how you’re sitting,
							whether your jaw is clenched, what is tense.</li>
						<li><strong>Now consider your day</strong>. What have you
							done already today? What is on the horizon for the rest of the
							day? Is there anything you can let go of? Can you create spaces
							between your tasks? Can you cull your tasks, getting rid of the
							non-essential, just leaving the best?</li>
						<li><strong>Learn to know the essential</strong>. It takes
							time to figure out what tasks give you the most impact on your
							life, your career, your ability to help others and change the
							world. But start learning today — pick what you think is most
							essential, clear some space, and just work on those things. Savor
							them.</li>
						<li><strong>Reduce distractions</strong>. Consider going on a
							digital cleanse — take a day or a week off of social media, news,
							entertainment/gossip sites, the places you usually spend on
							distractions. What will you do when you feel like some
							distraction? Meditate, exercise, create.</li>
					</ol>

					<p>Breathe. Enjoy the new space. Savor the beauty of doing
						less.</p>
