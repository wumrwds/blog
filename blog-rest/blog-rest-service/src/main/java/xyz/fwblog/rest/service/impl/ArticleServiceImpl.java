...
public class ArticleServiceImpl implements ArticleService {
	...
	public PortalArticleDetail getArticleById(Long articleId) {
		PortalArticleDetail article = articleMapper
	 ...
	 */
	@Override
	public List<PortalArticleEntity> getArticleByUser(Long userId) {
		List<PortalArticleEntity> articleList = articleMapper.selectArticleByUser(userId);
		return articleList;
	}
}
